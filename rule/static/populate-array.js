...
$(document).ready(function () {
    var EvolutionGrid = React.createClass({
        displayName: 'EvolutionGrid',

        render: function render() {
            var cells = [];
            this.props.evolution.map(function (row, step) {
                return row.map(function (cellValue, x) {
                    var key = x + ':' + step;
                    cells.push(React.createElement(Cell, { x: x, step: step, value: cellValue, key: key }));
                });
            });
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            ReactDOM.render(React.createElement(EvolutionGrid, { evolution: rows }), $('#array')[0]);
        }
    });
});
